module github.com/affanshahid/convoluted-movie-finder

go 1.17

require (
	github.com/affanshahid/configo v0.1.0
	github.com/cyruzin/golang-tmdb v1.3.8
...
require (
	...
	github.com/affanshahid/walkmap v1.0.2 // indirect
